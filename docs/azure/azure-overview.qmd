...
- **Ordering App** ([`terramax-ordering-app`](ordering-app/ordering-app-overview.md)): a user-facing web app that users can directly interact with to submit and manage Deals in HubSpot.  
