...
![Basic Diagram](images/diagram_basic.png)
...
These apps are served by a network of backend services:
    ...
    - The [PDF Service](architecture/azure/pdf-service/pdf-service.html), a @container app that receives an html document and returns it as a PDF document.
