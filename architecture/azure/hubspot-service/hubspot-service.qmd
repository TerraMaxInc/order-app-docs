...
- **Returns**
    - an HTTP response containing the list of Products from HubSpot, or an error message

- **Note** Is not accessible to any client apps and is not in regular use, but was valuable in early testing to better understand the HubSpot data structure, and may still have occasional dev/admin utility for viewing HubSpot data directly.
